...
public class BBDOTD {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\BB30Mar.xlsx";
            FileInputStream file = new FileInputStream(filePath);
            Workbook urlsWorkbook = new XSSFWorkbook(file);
            Sheet urlsSheet = urlsWorkbook.getSheet("Mar30");
...
//      				}
                  ...
                  try {
                	    Thread.sleep(2000);
                	    WebElement place = driver.findElement(By.xpath("/html/body/div[2]/div[1]/header[2]/div[1]/div[2]/div[1]/div[1]/div/div[1]/div[3]/ul/li[2]"));
                	    Thread.sleep(2000);
                	    place.click();
                     ...
                     /*  Pattern pattern = Pattern.compile("\\((.*?)\\)");
                      ...
                      BlinkitId screenshot = new BlinkitId();
	                   try {
                  	    ...
                  	    Thread.sleep(2000);
                  	    WebElement place = driver.findElement(By.xpath("/html/body/div[2]/div[1]/header[2]/div[1]/div[2]/div[1]/div[1]/div/div[1]/div[3]/ul/li[1]"));
                  	    Thread.sleep(2000);
                  	    place.click();
