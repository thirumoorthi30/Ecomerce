                ...
                try {
                    ...
                    //location sets 
                	  ...
                	  if (currentPin == null || !currentPin.equals(locationSet)) {
                		...
                		//  WebElement location = driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/header/div/div/div/span[1]"));
                		  ...
                		  WebElement location = driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div/div/div[2]/div[2]/div[1]/div/div[1]"));
        					location.click();
        					...
        					for (int j = 0; j < 150; j++) {
        						...
        						/*	driver.findElement(
        							...
        							driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div[2]/div[2]/div[1]/div/div[3]/div[2]/div[2]/div[2]")).click();
                	...
                	Thread.sleep(500);  
                	  try {
                          ...
                          WebElement nameElement = driver.findElement(By.xpath("//*[@id=\"product-details-page-container\"]/div/div[2]/div[1]/div[2]/div[2]/div[2]"));
                          ...
                          // Mrp 
                          try {
                          WebElement mrp = driver.findElement(By.xpath("//div[@class='sc-gEvEer gYPgVg _2XPBo _1QyO8']"));
                          	...
                          	try {
                                 ...
                                 // WebElement mrp = driver.findElement(By.xpath("/html/body/div[2]/div/div[7]/div[3]/div[4]/div[12]/div/div/div[4]/div[2]/span/span[1]/span[2]/span/span[2]"));
                                  ...
                                  System.out.println(mrpValue);
                          			...
                          			try {
                          				WebElement mrp = driver.findElement(By.xpath("//div[@class='sc-gEvEer enpNjw _2XPBo']"));
                                        originalMrp2 = mrp.getText();
                                        mrpValue = originalMrp2.replace("₹", "");
                                       // mrpValue = originalMrp2;                      
                                        System.out.println(mrpValue);
                         ...
                         try {
                          WebElement sp = driver.findElement(By.xpath("//div[@class='sc-gEvEer enpNjw _2XPBo']"));
...
//                   
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Swiggy_NY&Chri_OutputData" + timestamp + ".xlsx";
