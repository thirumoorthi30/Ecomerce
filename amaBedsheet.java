...
public class amaBedsheet {
	...
	public static void main(String[] args) {
		...
		UserUtility userUtility = new UserUtility(UserUtility.InputDataFilePath6, "Input data", "Locators");
		while (rowNum < userUtility.getNoOfRows(userUtility.InputDataSheet)) {
			try {
				...
				for (int i = 1; i < userUtility.getNoOfRows(userUtility.InputDataSheet); i++) {
					...
					/*
					 * if(InputBrandName.contains("Amazon")){ driver.manage().deleteAllCookies(); }
					 */
