...
public class amaElectronicsNewCode {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\amazon Elect input.xlsx";
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[4]/div[1]/p"));
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[4]/div[1]/h4"));
           ...
           /*         if(mrpValue == spValue) {
                 ...
                 //Out Of Stocks
                   ...
                   try {
                       ...
                       offerValue = originalOffer.replace("-","").replace("%","% Off");
                    	  ...
                    	  try {
                    	  WebElement offer = driver.findElement(By.xpath("//*[@id=\"corePrice_desktop\"]/div/table/tbody/tr[3]/td[2]/span[1]/text()"));
                          ...
                          System.out.println(offerValue);
                    		  ...
                    		  try {
                    			  WebElement offer = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[4]/div[1]/div"));
                                  String getOffer = offer.getText();
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Amazon_Electronics_Del_OutputData_" + timestamp + ".xlsx";
