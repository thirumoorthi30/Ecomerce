...
public class amazon29FebMar7ReqNew {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\amazon30April.xlsx";
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
                    ...
                    System.out.println(newName);
                    	...
                    	WebElement nameElement = driver.findElement(By.xpath("/html/body/div[2]/div/div[5]/div[3]/div[4]/div[1]/div/h1/span"));
                    	newName = nameElement.getText();
                        System.out.println(newName);
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("(//span[@class='a-price a-text-price'])[3]"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("(//span[@class='a-price a-text-price']//span)[1]"));
                           ...
                           // mrpValue = originalMrp2;                      
                    		...
                    		try {
                    		WebElement mrp = driver.findElement(By.xpath("(//span[@class='a-size-base a-color-secondary'])[1]"));
                           // WebElement mrp = driver.findElement(By.xpath("/html/body/div[2]/div/div[7]/div[3]/div[4]/div[12]/div/div/div[4]/div[2]/span/span[1]/span[2]/span/span[2]"));
                            ...
                            System.out.println(mrpValue);
                    			...
                    			try {
                            		WebElement mrp = driver.findElement(By.xpath("((//span[@class='a-price a-text-price a-size-base'])[1]//span)[1]"));
                            		originalMrp3 = mrp.getText();
                            		if(originalMrp3.contains("₹")){
                            			 mrpValue = originalMrp3.replace("₹", "");
                            		}else {
