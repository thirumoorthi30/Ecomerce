...
public class amazon30MarApr7Req {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            for (int i = 0; i < uRL.size(); i++) {
               ...
               /*     if(i == 0) {
                    	try {
                    	WebElement skip = driver.findElement(By.xpath("//*[@id=\"GLUXProgramSpecificSheetSkipLink\"]/a"));
                    	skip.click();
                    	}
                    	catch(Exception s) {
                    ...
                    if (currentPin == null || !currentPin.equals(locationSet)) {
                    	try {
                    	Thread.sleep(3000);
                    	 WebElement location = driver.findElement(By.id("glow-ingress-line2"));
     					location.click();
                    }
                    	catch(Exception r) {
                    		Thread.sleep(3000);
                    ...
                    try {
                    //WebElement mrp = driver.findElement(By.xpath("//*[@id=\"corePrice_desktop\"]/div/table/tbody/tr[1]/td[2]/span/span"));
                    WebElement mrp = driver.findElement(By.xpath("(//div[@class='a-section a-spacing-small aok-align-center']//span)//span[@class='a-offscreen']" ));
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//*[@id=\"priceblock_ourprice\"]/span"));
           ...
           /*         if(mrpValue == spValue) {
                	 ...
                	 //*[@id="corePriceDisplay_desktop_feature_div"]/div[1]/span[2]/span[2]/span[2]
                	   try {
                	   WebElement sp = driver.findElement(By.xpath("/html/body/div[2]/div/div[5]/div[3]/div[4]/div[13]/div/div/div[4]/div[2]/span/span[1]/span[2]/span/span[1]"));
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Amazon_ 8 website_OutputData_ " + timestamp + ".xlsx";
