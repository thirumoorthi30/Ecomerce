...
public class bigbasketDOTD {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\BB30March.xlsx";
            FileInputStream file = new FileInputStream(filePath);
            Workbook urlsWorkbook = new XSSFWorkbook(file);
            Sheet urlsSheet = urlsWorkbook.getSheet("Mar31");
            ...
            for (int i = 0; i < uRL.size(); i++) {
               ...
               /* 	  if (currentPin == null || !currentPin.equals(locationSet)) {
                  ...
                  try {
                	    ...
                	    try {
                	        place = driver.findElement(By.xpath("/html/body/div[2]/div[1]/header[2]/div[1]/div[2]/div[1]/div[1]/div/div[1]/div[3]/ul/li[2]"));
                	    } catch (NoSuchElementException e) {
                	        place = driver.findElement(By.xpath("/html/body/div[2]/div[1]/header[2]/div[1]/div[2]/div[1]/div[1]/div/div[1]/div[3]/ul/li[1]"));
                	    }
                	    Thread.sleep(2000);
                	    place.click();
      	  ...
      	  ((ChromeDriver) driver).executeScript("window.open();");
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("//*[@id=\"siteLayout\"]/div/div/section[1]/div[2]/section[1]/table/tr[1]/td[2]"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("//*[@id=\"siteLayout\"]/div/div/section[1]/div[2]/section[1]/table/tr[1]/td[1]/text()[2]"));
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//*[@id=\"siteLayout\"]/div/div/section[1]/div[2]/section[1]/table/tr[2]/td[1]"));
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Bigbasket_7 days_OutputData_ MAR 31 " + timestamp + ".xlsx";
