    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
                     ...
                     //  blinkitproofofconcept@gmail.com
                      ...
                      try {
                       ...
                       remove.click();
                      	...
                      	Thread.sleep(4000); 
                       WebElement remove = driver.findElement(By.xpath("//*[@id=\\\"productlist\\\"]/div/div[6]/div[1]/span[2]")); //xpath changed	
                       remove.click();
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Firstcry_Baby Products_OutputData_" + timestamp + ".xlsx";
