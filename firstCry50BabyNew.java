...
public class firstCry50BabyNew {
    ...
    public static void main(String[] args) throws Exception{
      //  System.setProperty("webdriver.chrome.driver", "./Drivers//chromedriver.exe");
        ...
        try {
            ...
            String filePath = ".\\input-data\\firstcry50BabyNew.xlsx";
            FileInputStream file = new FileInputStream(filePath);
            Workbook urlsWorkbook = new XSSFWorkbook(file);
            Sheet urlsSheet = urlsWorkbook.getSheet("Secondhalf");
...
//                                          System.out.println("Last 7 Characters Before '*': " + last7Chars);
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Firstcry_Baby50New_OutputData_Secondhalf" + timestamp + ".xlsx";
