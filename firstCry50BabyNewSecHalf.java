...
public class firstCry50BabyNewSecHalf {
...
//                      clickApply.click();
                      ...
                      regmail.click();
                      Thread.sleep(5000);
                      regmail.sendKeys("firstgurgoan80@gmail.com");//blktpoc2000@gmail.com
...
//                                          System.out.println("Last 7 Characters Before '*': " + last7Chars);
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Firstcry_Baby_SecondHALF_OutputData_" + timestamp + ".xlsx";
