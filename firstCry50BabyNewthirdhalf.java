...
public class firstCry50BabyNewthirdhalf {
    ...
    public static void main(String[] args) throws Exception{
      //  System.setProperty("webdriver.chrome.driver", "./Drivers//chromedriver.exe");
        ...
        try {
            ...
            Sheet urlsSheet = urlsWorkbook.getSheet("FirstCry3");
            int rowCount = urlsSheet.getPhysicalNumberOfRows();
	            ...
	            List<String> inputPid = new ArrayList<>(),InputCity = new ArrayList<>(),InputName = new ArrayList<>(),InputSize = new ArrayList<>(),NewProductCode = new ArrayList<>(),
	            		uRL = new ArrayList<>(),UOM = new ArrayList<>(),Mulitiplier = new ArrayList<>(),Availability = new ArrayList<>(),Pincode = new ArrayList<>();
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                if (urlCell != null && urlCell.getCellType() == CellType.STRING) {
                    ...
                    String pincode = (pincodeCell != null && pincodeCell.getCellType() == CellType.STRING) ? pincodeCell.getStringCellValue() : "";
...
//                      clickApply.click();
                      ...
                      regmail.click();
                      Thread.sleep(5000);
                      regmail.sendKeys("blinkitfirst456@gmail.com");//blktpoc2000@gmail.com
...
//                	      }
                      ...
                      System.out.println(mrpValue);
                      		...
                      		try {
                          WebElement mrp = driver.findElement(By.xpath("//span[@class='prod-price J15B_42  cl_21']"));
                          mrpValue = mrp.getText();                            
                          System.out.println(mrpValue);
                      		}
                      		catch(Exception o) {
...
//                                          System.out.println("Last 7 Characters Before '*': " + last7Chars);
                      ...
                      for (int p = 0; p < offersList.size(); p++) {
                          ...
                          wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/form/section[1]/section[5]/div[4]/div[8]/div[2]/div[3]/div/span[2]")));
                          WebElement applyClick = driver.findElement(By.xpath("/html/body/form/section[1]/section[5]/div[4]/div[8]/div[2]/div[3]/div/span[2]"));
                          actions.moveToElement(applyClick).click().perform();
                          Thread.sleep(6000);

                          WebElement rate1 = driver.findElement(By.xpath("/html/body/form/section[1]/section[5]/div[4]/div[10]/div[4]/span[2]"));
                       ...
                       remove.click();
                         ...
                         count=1;
                          ...
                          try {
                              ...
                              try {
                              WebElement mrp = driver.findElement(By.xpath("//span[contains(., 'MRP:')]/del[1]"));
                              mrpValue = mrp.getText();
                              System.out.println(mrpValue);
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Firstcry_Baby_OutputData_THIRDhalf" + timestamp + ".xlsx";
