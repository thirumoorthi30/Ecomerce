...
//                      Thread.sleep(20000);
                      ...
                      for (int j = 1; j <= divCount; j++) {
                    	  try {
                    		 ...
                    		 // System.out.println(xpath);
                    		  offertext = driver.findElement(By.xpath(xpath+"//div[@class='club-txt-logo']/parent::div/span")).getText();
                    		  System.out.println("offer text:"+offertext);
                    		  if(offertext.contains("Extra") || offertext.contains("extra")) {
                    			  
                    		  }
                    		  Thread.sleep(1000);
                    		  code = driver.findElement(By.xpath(xpath+"//ancestor::div[@class='save_cpn_header']/following-sibling::div//div[contains(@class,'cpn_code_box')]")).getText();
                      ...
                      // Store offers and coupon codes
                      offers.put(offertext, code);
                     // offers.put("FLAT 35% OFF* FOR NON CLUB", "MOAS24");
                      
                
                     // String value1 = offers.get("FLAT 35% OFF* FOR NON CLUB");
                     // System.out.println("Value for key 'key1': " + value1); 
                      
                      
                     // public class DynamicMapExample {
                    	   // public static void main(String[] args) {
                    	        // Example: Suppose you are generating key-value pairs dynamically
                    	        // In a real scenario, you might generate these pairs in a loop or from a method
                    	        Map<String, String> keyValuePairs = generateKeyValuePairs();
                    	    ...
                    	    // Method to generate dynamic key-value pairs (simulated for demonstration)
                    	   // public static Map<String, String> generateKeyValuePairs() {
                    	        Map<String, String> map = new HashMap<>();
                    	        
                    	        // Generate key-value pairs dynamically (example)
                    	        map.put("key1", "value1");
                    	        map.put("key2", "value2");
                    	        map.put("key3", "value3");
                    	        
                    	        // Simulate dynamic generation of more pairs (example)
                    	        for (int l = 4; l <= 10; l++) {
	...
	private static Map<String, String> generateKeyValuePairs() {
