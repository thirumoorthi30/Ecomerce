...
public class flipElectronicsNew {
        ...
        try {
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
					...
					/*	WebElement location = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[5]/div/div/div[1]/div[2]/div/div[2]/div[1]/form"));
						...
						for (int j = 0; j < 150; j++) {
							try {
								...
								driver.findElement(
										By.xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[5]/div/div/div[1]/div[2]/div/div[2]/div/form/input")).clear();
							...
							/*	driver.findElement(
								...
								for (int k = 0; k <= 50; k++) {
									try {
										tempPinNumber = driver.findElement(By.xpath(
												"/html/body/div[1]/div/div[3]/div[1]/div[2]/div[5]/div/div/div[1]/div[2]/div/div[2]/div/form/input"))
												.getAttribute("value");
								...
								driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[5]/div/div/div[1]/div[2]/div/div[2]/div[1]/span")).click();
								break;
							} catch (Exception e) {
								e.getCause();
								if (j == 300) {
                    ...
                    System.out.println(newName);
                    	...
                    	try {
                    		WebElement nameElement = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[2]/div/div[1]/h1/span"));
                        	newName = nameElement.getText();
                            System.out.println(newName);
                    	}
                    	catch(Exception ex) {
                    		WebElement nameElement = driver.findElement(By.xpath("/html/body/div/div/div[3]/div[1]/div[2]/div[1]/div/div[1]/h1/span"));
                        	newName = nameElement.getText();
                            System.out.println(newName);
                    	}
                    }
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[2]/div/div[4]/div[1]/div/div[2]"));
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[2]/div/div[4]/div[1]/div/div[1]"));
           ...
           /*         if(mrpValue == spValue) {
                 ...
                 //Out Of Stocks
                   ...
                   int result = 1; // Default availability is 1

                   try {
                       String xpathForFlipkart = "//*[@id=\"container\"]/div/div[3]/div[1]/div[1]/div[2]/div/button";
                       String xpathForSecond = "/html/body/div[1]/div/div[3]/div[1]/div[2]/div[5]/div/div/div[2]/div";
                       String xpathForThird = "//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[2]/div";

                       boolean isFirstPresent = !driver.findElements(By.xpath(xpathForFlipkart)).isEmpty();
                       boolean isSecondPresent = !driver.findElements(By.xpath(xpathForSecond)).isEmpty();
                       boolean isThirdPresent = !driver.findElements(By.xpath(xpathForThird)).isEmpty();

                       // If either of the XPaths is present, set result to 0
                       if (isFirstPresent || isSecondPresent || isThirdPresent) {
                           result = 0;
                       }
                       else {
                    	   result = 1;
                   ...
                   try {
                	   WebElement offer = driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[2]/div/div[4]/div[1]/div/div[3]/span"));
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Flipkart_Electronics_Del_OutputData_" + timestamp + ".xlsx";
