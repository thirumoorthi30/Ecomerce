	...
	public static void main(String[] args) throws Exception {
      ...
      //  System.setProperty("webdriver.chrome.driver", "./Drivers//chromedriver.exe");
		...
		try {
			...
			String filePath = ".\\input-data\\amazonBabyGur.xlsx";
			...
			headerRow.createCell(6).setCellValue("Ratings");
			headerRow.createCell(7).setCellValue("Review Count");
			...
			for (int i = 0; i < uRL.size(); i++) {
				...
				try {
			        ...
			        // Find an element on the page to scroll down to (e.g., footer)
			        WebElement footer = driver.findElement(By.tagName("footer"));

			        // Perform multiple page down actions to scroll down the page
			        for (int p = 0; p < 5; p++) {
			            actions.sendKeys(Keys.PAGE_DOWN).perform();
			            // Add a delay to allow content loading
			            try {
					...
					try{
						...
						WebElement ratings = driver.findElement(By.xpath("//section[@class='css-zu35w1']//strong[@class='css-1297gf2']"));
					...
					try{
						WebElement reviewCounts = driver.findElement(By.xpath("//section[@class='css-zu35w1']//div[@class='css-ntrqan']//span[@class='css-v6hqrc']"));
			...
			try {
				...
				String outputFilePath = ".\\Output\\Amazon_Baby Gur_OutputData_" + timestamp + ".xlsx";
