...
public class swiggyDemoo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\swiggy30Mar.xlsx";
            FileInputStream file = new FileInputStream(filePath);
            Workbook urlsWorkbook = new XSSFWorkbook(file);
            Sheet urlsSheet = urlsWorkbook.getSheet("Apr4");
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
                    ...
                    // Mrp 
                    try {
                    WebElement mrp = driver.findElement(By.xpath("//*[@id=\"product-details-page-container\"]/div/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[2]"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[4]/div[1]/p"));
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//*[@id=\"product-details-page-container\"]/div/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]"));
                   ...
                   if(url.contains("NA")){
					...
					int result = 1;
					try {
					String xpathForSwiggy = "//*[@id=\"product-details-page-container\"]/div/div[2]/div[1]/div[2]/div[2]/div[2]/div";

					
					boolean isElementPresent = !driver.findElements(By.xpath(xpathForSwiggy)).isEmpty();
                    ...
                    resultRow.createCell(9).setCellValue(uomNew);
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Swiggy28feb_OutputData_  Apr4 " + timestamp + ".xlsx";
