...
public class zeptoDemoo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\zepto30Mar.xlsx";
            FileInputStream file = new FileInputStream(filePath);
            Workbook urlsWorkbook = new XSSFWorkbook(file);
            Sheet urlsSheet = urlsWorkbook.getSheet("Apr7");
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
                  ...
                  Thread.sleep(9000); 	
                   ...
                   for(int k=0;k < 100;k++) {
        					...
        					break;
                    				...
                    				Thread.sleep(4000);
                   					...
                   					break;
                    					...
                    					Thread.sleep(4000);
                                     	 WebElement location = driver.findElement(By.xpath("/html/body/div/div/div/header/div/div[1]/button/span"));          			 
                      					location.click();
                      					Thread.sleep(3000);
                      					break;
                    				}
     				...
     				//	Thread.sleep(1000);909
     					...
     					for (int j = 0; j < 200; j++) {
     						try {         
     							...
     							driver.findElement(
     									By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div[2]/div[1]/input"))
     									.sendKeys(Keys.ENTER);
     							
     							Thread.sleep(3000);
     							
     							driver.findElement(
     									By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div[2]/div[1]/input")).clear();
     							...
     							driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[2]/div/div")).click();
     						...
     						/*	driver.findElement(
     							...
     							driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div/div/div[2]/div/button[2]/div")).click();
                    ...
                    WebElement nameElement = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div[1]/div[1]/div[2]/div[2]/div/h1"));
                    ...
                    System.out.println(newName);
                    	...
                    	WebElement nameElement = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div/div[1]/div[2]/div[3]/div/h1"));
                    	newName = nameElement.getText();
                        System.out.println(newName);
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div[1]/div[1]/div[2]/div[4]/div[1]/p"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div/div[1]/div[2]/div[5]/div[1]/p"));
                           ...
                           // mrpValue = originalMrp2;                      
                    		...
                    		try {
                    		WebElement mrp = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[5]/div[1]/p"));
                           // WebElement mrp = driver.findElement(By.xpath("/html/body/div[2]/div/div[7]/div[3]/div[4]/div[12]/div/div/div[4]/div[2]/span/span[1]/span[2]/span/span[2]"));
                            ...
                            System.out.println(mrpValue);
                    			...
                    			try {
                    				WebElement mrp = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[4]/h4"));
                                    // WebElement mrp = driver.findElement(By.xpath("/html/body/div[2]/div/div[7]/div[3]/div[4]/div[12]/div/div/div[4]/div[2]/span/span[1]/span[2]/span/span[2]"));
                                     originalMrp3 = mrp.getText();
                                     mrpValue = originalMrp3.replace("₹", "");                      
                                     System.out.println(mrpValue);
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div[1]/div[1]/div[2]/div[4]/div[1]/h4"));
                    ...
                    System.out.println(spValue);
                	   ...
                	   try {
                	   WebElement sp = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div/div[1]/div[2]/div[5]/div[1]/h4"));
                   ...
                   if(url.contains("NA")){
					...
					int result = 1;
					try {
					String xpathForZepto = "/html/body/div/div/div/div[3]/div[2]/div[1]/div[2]/div[2]/div[4]/div/div/button";
				...
				//	if(NewAvailability1 == "0") {
                   try {
                       WebElement offer = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div[1]/div[1]/div[2]/div[4]/div[1]/div"));
                      ...
                      /* Pattern pattern = Pattern.compile("\\((.*?)\\)");
                       ...
                       System.out.println(offerValue);
                    	  ...
                    	  try {
                   	   WebElement offer = driver.findElement(By.xpath("/html/body/div/div/div/div/div[2]/div/div[1]/div[2]/div[5]/div[1]/div"));
                   	    offerValue = offer.getText();
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Zepto_7 days_OutputData_ Apr7 " + timestamp + ".xlsx";
